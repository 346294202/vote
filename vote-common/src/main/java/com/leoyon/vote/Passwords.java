...
public class Passwords {
	...
	public static String encode(String value, String salt) throws Exception {
...
//		// 字符数组转换成字符串返回
	...
	public static boolean match(String password, String password2, String salt) throws Exception  {
		return encode(password, salt).equals(encode(password2, salt));
	}
