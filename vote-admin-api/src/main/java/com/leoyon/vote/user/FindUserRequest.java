...
public class FindUserRequest {
	...
	public static class FindUserRequestMethodArgumentResolver implements HandlerMethodArgumentResolver {
	...
	public FindUserRequest(String q, Integer page, Integer psize, Integer active, Integer superuser, Integer staff) {
		super();
		this.q = q;
		this.page = page;
		this.psize = psize;
