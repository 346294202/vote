...
public class JuheSms {
	...
	// 配置您申请的KEY
	public static final String APPKEY = "8873e17b5b8a341359df2459f40c4e9f";
	...
	public static void getRequest1() {
		...
		params.put("word", "尼玛");// 需要检测的短信内容，需要UTF8 URLENCODE
	...
	public static void getRequest2() throws UnsupportedEncodingException {
		...
		Map params = new HashMap();// 请求参数
		params.put("mobile", "15158087185");// 接收短信的手机号码
		params.put("tpl_id", "60458");// 短信模板ID，请参考个人中心短信模板设置
		params.put("tpl_value", URLEncoder.encode("#code#=1234", "UTF-8"));// 变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a
	...
	public static void sendVerifyCode(String mobile, String code) throws Exception {
		String url = "http://v.juhe.cn/sms/send";// 请求接口地址
	...
	public static void main(String[] args) throws Exception {
		sendVerifyCode("15158087185", "2323");
	}
